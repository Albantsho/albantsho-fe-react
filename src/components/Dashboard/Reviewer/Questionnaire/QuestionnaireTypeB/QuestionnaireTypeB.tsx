...
import useQuestionnaireTypeB from "./useQuestionnaireTypeB";
...
const QuestionnaireTypeB = ({ reviewValuesTypeB, script }: IProps) => {
  const {
    completed,
    countRate,
    ...
    completeFileFunc,
    loading,
  } = useQuestionnaireTypeB({ reviewValuesTypeB });
...
export default QuestionnaireTypeB;
