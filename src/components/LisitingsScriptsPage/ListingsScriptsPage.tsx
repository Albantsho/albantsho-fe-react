...
import AuctionsScripts from "./AuctionsScripts/AuctionsScripts";

const ListingsScriptsPage = () => {
  return (
    <div className="px-6 py-6 sm:px-11   mt-4 md:mt-6 bg-white rounded-md">
...
export default ListingsScriptsPage;
