...
const ListScriptsInReviews = () => {
  return (
    <Table className="mt-4 bg-white rounded-md  shadow-sm  pt-5 flex flex-col min-h-screen">
      <TableHead>
        <TableRow className="flex ">
          <TableCell className="flex-1   2xl:flex-[0.51]  md:pl-3 lg:pl-10 xl:pl-16 2xl:pl-16">
            Script
          </TableCell>
          <TableCell className=" hidden md:flex flex-[0.80] xl:flex-1  md:pr-3 lg:pr-6 xl:pr-12">
            Status
          </TableCell>
        </TableRow>
      </TableHead>
        ...
        {listScripts.map((script) => (
          ...
          >
            <TableCell className="flex  flex-1 2xl:flex-[0.5] sm:gap-4 flex-wrap sm:flex-nowrap gap-2  lg:min-w-[280px]  items-center sm:items-start">
              ...
              <div className="sm:flex-1 sm:max-w-[300px]">
                <Typography
                  variant="body1"
            ...
            <TableCell className="hidden sm:flex flex-[0.80] xl:flex-1 items-center gap-1 justify-between">
              <Chip
                label={script.status}
                className={`${
                  script.status === "Reviewed"
