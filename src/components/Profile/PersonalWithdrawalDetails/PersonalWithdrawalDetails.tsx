    ...
    <div>
      ...
      <div className="flex flex-col md:mt-8 py-7 gap-3 gap-y-6 md:items-start  md:flex-row md:gap-x-10">
        ...
        <div className="gap-y-5 md:gap-y-6 flex flex-col md:flex-1">
          <div>
            <label htmlFor="account-name" className="inline-block md:text-lg mb-1 futura">
              Account Name
            </label>
            <CustomInput
          ...
          <div>
            <label htmlFor="bank" className="inline-block md:text-lg mb-1 futura">
              Bank
            </label>
            <CustomInput
              sx={{ "& .MuiInputBase-input": { color: "#9A7EC7", py: "13px" } }}
          ...
          <div>
            <label htmlFor="USDT" className="inline-block md:text-lg mb-1 futura">
              USDT TRC20 Address
            </label>
            <CustomInput
              sx={{ "& .MuiInputBase-input": { color: "#9A7EC7", py: "13px" } }}
