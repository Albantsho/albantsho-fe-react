  ...
  return (
    <div className="flex justify-start text-primary-700 items-center mt-8">
      <div className="flex gap-4 flex-1 w-full">
        <IconButton color="inherit" onClick={back} className="bg-white">
        ...
        <div className="flex items-center bg-white py-2 px-5 rounded-md gap-2 flex-1 md:flex-grow-0 md:min-w-[350px] md:w-auto">
          <RiSearch2Line className="text-gray-400 text-2xl md:mr-1   text-xl" />
          <input
            placeholder="Search"
            className=" outline-none border-none  placeholder:text-gray-400 text-base text-gray-600 w-full md:w-auto"
          />
        </div>
      </div>
