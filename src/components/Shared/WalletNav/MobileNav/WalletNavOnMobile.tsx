...
import useWalletNavOnMobile from "./useWalletNavOnMobile";
...
const WalletNavOnMobile = ({ isTransparent }: IProps) => {
  const { handleToggleDrawer, open, balance } = useWalletNavOnMobile();
