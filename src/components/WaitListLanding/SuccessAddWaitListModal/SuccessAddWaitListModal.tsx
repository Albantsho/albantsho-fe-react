...
const SuccessAddWaitListModal = ({
  ...
  return (
    <Modal
      className="px-5"
      open={successAddWaitList}
      onClose={handleCloseSuccessAddWaitListModal}
    >
      <Grow in={successAddWaitList}>
        <div className="relative text-white bg-[#573195] w-full mt-12 lg:mt-28 max-w-lg mx-auto flex flex-col pt-10 pb-3">
          <IconButton
            color="inherit"
          ...
          <p
            ...
            className="max-w-[315px] px-6 sm:px-10 text-sm sm:max-w-full text-center mx-auto text-[#DDD4EC]"
          >
          ...
          <button
            onClick={handleCloseSuccessAddWaitListModal}
            style={{ fontFamily: "Inter" }}
            className="px-8 py-4 font-semibold cursor-pointer bg-white w-fit mx-auto rounded-lg text-[#573195]"
          >
            Okay, great!
          </button>
        </div>
