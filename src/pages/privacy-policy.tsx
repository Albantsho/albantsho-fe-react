    ...
    <>
      ...
      <div className="max-w-screen-lg px-5 sm:px-10 mx-auto py-14 relative">
        ...
        <Typography paragraph>
          ...
          “Scripts Sellers and Buyers”. Consequently, we are pleased to inform
          our users of the privacy policy that govern our relationship with
          customers.
        </Typography>
        <br />
        ...
        <Typography paragraph className="mt-2">
          This privacy policy (Policy) together with our User Terms of Service
          as set out at (link for user terms) and any additional terms of use
        ...
        <div className="px-6 mt-2 lg:px-12">
          ...
          >
            ...
            installed a copy of the platform onto your mobile telephone,
            handheld device or any other computerized device (Device).
          </Typography>
          <Typography
        ...
        <Typography paragraph className="mt-2">
          ...
          has already been provided to Albantsho upon signing up on our
          platform.
        </Typography>
        <br />
        <TitleComponent>
        ...
        >
          <div className="mt-2 px-6 lg:px-12">
            ...
            <div>
              ...
              >
                ...
                the Albantsho brand (for example, by phone call, e-mail or
                chat);
              </Typography>
              <Typography
                className="text-[#484848] px-3 lg:px-5 font-normal list-inside list-item list list-disc"
              ...
              >
                ...
                functions, entering a competition, rating services, promotion,
                or survey, and reporting a problem with the platform, our
          ...
          <div className="mt-2 px-6 lg:px-12">
            <Typography paragraph>
              ...
              <br />
              When you send an email or other communications to us, we may
              ...
              instances where any of the following information may be required
              to be processed byAlbantsho and in which case your express
            ...
            <div>
              ...
              >
                ...
                number), information about the SIM card used by the Device,
              ...
              >
                ...
                logs, SMS logs, Facebook friends, contact lists from other
              ...
              <Typography
                ...
                paragraph
              >
                details of your use of any of our platforms or your visits to
                Our Service Sites; including, but not limited to, traffic data,
          ...
          <div className="mt-2 px-6 lg:px-12">
            <Typography paragraph>
              ...
              our collection, processing or use of this information at any time
              by logging out and uninstalling the platform from your Device.
            </Typography>
          </div>
          <div className="mt-2 px-6 lg:px-12">
            <Typography paragraph>
          ...
          <div className="px-3 lg:px-6">
            ...
            <div className="my-2 px-3 lg:px-6">
              <Typography paragraph>
                ...
                which you are a party to or in order to take steps at your
                request prior to entering into a contract or for the provision
            ...
            <Typography paragraph>
              ...
              the purpose for which your data was obtained, we shall undertake
              to procure your consent prior to the use of your data for that
              other purpose. Provided that this reqirement will not extend to
              matters coverd by clasue H below.
            </Typography>
            <Typography paragraph>
              ...
              all, or a portion of, its business or assets (including in the
              event of an internal or external restructuring, reorganization,
              ...
              controllers and/or processors of your personal data that was held
              by Albantsho Limited prior to such arrangement. Albantsho Limited
              shall at all times ensure that you are notified when your personal
              data is intended to be transferred to third parties in the
              circumstances outlined in this clause.
            </Typography>
            <Typography paragraph>
              ...
              the right to request the modification or amendment of your
              personal data in our possession. Provided that in all cases of
              access or modification/amendment of personal information, we shall
              request sufficient identification, and utilise our identification
              policies to enable us to confirm that you are the owner of the
              data sought to be accessed or modified/amended.
            </Typography>
          </div>
        </SubtitleComponent>
        <br />
        ...
        >
          <div className="px-6 my-2">
            <Typography
              ...
              paragraph
            >
              processed lawfully, fairly, in a transparent manner and with
            ...
            >
              ...
              subject for longer than is necessary for the purposes for which
        ...
        >
          <div className="px-6 my-2 lg:px-12">
            ...
            <Typography className="text-[#484848]" paragraph>
              ...
              rights, property or safety of its users or the public as required
              or permitted by law.
            </Typography>
          </div>
        </SubtitleComponent>
        ...
        >
          <div className="px-6 my-2 lg:px-12">
            <Typography className="text-[#484848]" paragraph>
              i. in the event that we sell or buy any business or assets, in
              which case we may disclose your personal data (such as but note
              limited to -Name, Phone number, address, nationality, date of
              birth) to the prospective seller or buyer of such business or
              assets;
            </Typography>
            <Typography className="text-[#484848]" paragraph>
            ...
            <Typography className="text-[#484848]" paragraph>
              iii. if we are under a duty to disclose or share your personal
              data in order to comply with any legal or regulatory obligation or
            ...
            <Typography className="text-[#484848]" paragraph>
              ...
              agreements or to investigate potential breaches; or for the
              purpose of publishing statistics relating to the use of the
